...
{ // Turn LED On or Off
    ...
    gpio_set_level(LED_STRIP_PIN, en && led_duty > 0);

    /** Turn on night mode (based off of https://github.com/xenpac/ESP32-CAM-Linux-Motion/blob/main/main/tcpserver.c) */
...
#ifdef CONFIG_LED_ILLUMINATOR_ENABLED
    enable_led(true);
    vTaskDelay(1000 / portTICK_PERIOD_MS); // The LED needs to be turned on ~1000ms before the call to esp_camera_fb_get()
